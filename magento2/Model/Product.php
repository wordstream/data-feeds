...
namespace WordStream\DataFeed\Model;
...
use WordStream\DataFeed\Api\ProductInterface;
use WordStream\DataFeed\Model\Product\ValidatorInterface;
use WordStream\DataFeed\Model\Product\ResponseCreatorInterface;

/**
 * Class Product encapsulates logic for webapi requests handling.
 * @package WordStream\DataFeed\Model
 * @author  akozyr
 */
class Product implements ProductInterface
{
    ...
    private $request;
    /**
     * @var \WordStream\DataFeed\Model\ResponseCreatorInterface
     */
    private $responseCreator;
    /**
     * @var \WordStream\DataFeed\Model\ValidatorInterface
     */
    private $validator;
    /**
