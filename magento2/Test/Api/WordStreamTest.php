...
namespace WordStream\DataFeed\Test\Api;
...
class WordStreamTest extends WebapiAbstract
{
    const SERVICE_NAME = 'WordStreamProductV1';
    const SERVICE_VERSION = 'V1';
    const RESOURCE_PATH = '/V1/WordStream';

    /**
     * Get information about product with entity_id = :id
     *
     * @magentoApiDataFixture ../../../../app/code/WordStream/DataFeed/Test/_files/product_simple.php
     */
     ...
     *
     * @magentoApiDataFixture ../../../../app/code/WordStream/DataFeed/Test/_files/products_new_website.php
     ...
     *
     * @magentoApiDataFixture ../../../../app/code/WordStream/DataFeed/Test/_files/products_in_category.php
